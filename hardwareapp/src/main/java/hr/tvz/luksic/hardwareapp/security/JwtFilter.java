package hr.tvz.luksic.hardwareapp.security;

import hr.tvz.luksic.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        return hr.tvz.luksic.hardwareapp.security.SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
